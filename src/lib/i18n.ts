...
export const ui = {
  zh: {
    ...
    disclaimer: "聲明",
    disclaimerText:
      "這是個人化的數位筆記，不是臨床指引。教育用途，不能取代個別判斷或官方 DSM-5 / DSM-5-TR 文本。不重製受著作權保護的診斷準則原文。",
    related: "相關筆記",
    ...
    index: "索引目錄",
    featured: "精選筆記",
    heroLead: "Digital Brain · 第二大腦",
    heroBody:
      "把龐大的知識架構收斂成一座五層金字塔。底層是心智的結構，頂層是形而上學。繁中版會在術語後括注英文，例如：依附理論 (Attachment Theory)。",
    enterMap: "進入金字塔",
    enterLevel1: "從底層開始",
    ...
    aboutTitle: "關於這座數位筆記",
    aboutBody:
      "這不是給大眾的衛教網站，而是把神經科學硬底子與東方哲學串成個人思考地圖的第二大腦。知識依金字塔生長，而不是依科別堆積。",
    aboutTech: "如何生長",
    aboutTechBody:
  ...
  en: {
    brandSub: "Second brain · Map of Our Mind",
    search: "Search",
    menu: "Menu",
    close: "Close",
    about: "About",
    ...
    disclaimerText:
      "A personal digital notebook, not a clinical guideline. Educational use only. This does not replace judgment or the official DSM-5 / DSM-5-TR text. Diagnostic criteria are not reproduced.",
    related: "Related notes",
    relatedHint: "Notes grow along a thinking path, not along departmental silos.",
    updated: "Updated",
    backHome: "← Digital Brain",
    pyramid: "Map of Our Mind",
    index: "Index",
    featured: "Featured notes",
    heroLead: "Digital Brain · second brain",
    heroBody:
      "A five-level pyramid: structure of mind at the base, metaphysics at the apex. In Chinese, terminology appears as 中文 (English).",
    ...
    searchLead: "Search the second brain",
    ...
    aboutTitle: "About this digital brain",
    aboutBody:
      "Not a public health site. A personal map that joins hard neuroscience with Eastern philosophy. Knowledge grows as a pyramid instead of accumulating by specialty.",
