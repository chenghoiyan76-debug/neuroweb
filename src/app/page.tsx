    ...
    <div>
      ...
      <section className="border-t border-rule">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-10">
          <div>
            <p className="font-serif text-xl">{t.studyCorner}</p>
            <p className="mt-1 text-sm text-ink-soft">{pick(content.profile.tagline, locale)}</p>
          </div>
          <div className="flex flex-wrap gap-3 text-sm">
            <Link href="/notes" className="rounded-full border border-rule px-4 py-1.5 hover:border-gold">
              {t.notes}
            </Link>
            <Link href="/books" className="rounded-full border border-rule px-4 py-1.5 hover:border-gold">
              {t.books}
            </Link>
            <Link href="/about" className="rounded-full border border-rule px-4 py-1.5 hover:border-gold">
              {t.about}
            </Link>
          </div>
        </div>
